...
const schema = yup
  .object({
    username: yup.string().required("Email is required").email("Username must be a valid email"),
...
function Login() {
  ...
  res.then((res) => {
      ...
      if(Response){
        ...
        window.location.href="/solar_design"  
      }else{
            ...
            <div className="login-main-box">
              ...
              <div className="login-form-box">
                ...
                <div className="login-form">
                  <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        {...register("username")}
                      />
                      <p style={{color: "red", paddingTop: 3}}>{errors.username?.message}</p>
                    </Form.Group>
                    <Form.Group
                      className="form-group mb-3"
                      controlId="formBasicEmail"
                 ...
                 <p style={{textAlign: "right", padding: "5px"}}>
                    <span style={{ color: "#02528A", cursor: "pointer" }} onClick={()=>history.push("/forgetpassword")}>
              ...
              >
                <p>
                  ...
                  <span style={{ color: "#02528A", cursor: "pointer" }} onClick={() => history.push("/signup")}>
                    Create Account
                  </span>
                </p>
              </div>
